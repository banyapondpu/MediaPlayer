...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclerView, recyclerViewRow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewRow = (RecyclerView)findViewById(R.id.data_row);
        ...
        recyclerViewRow.setLayoutManager(linearLayoutManager_row);

        dataAdapter = new DataAdapter(result);
        recyclerView.setAdapter(dataAdapter);
        recyclerViewRow.setAdapter(dataAdapter);
